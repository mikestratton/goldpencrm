...
<head>
    ...
    @endif
    <style>
        /* Add !important to ensure custom styles override Tailwind */
        form {
                    ...
                    <div class="mb-8">
                        <form action="{{ route('salesai.process') }}" method="POST">
                            ...
                            <div>
                                ...
                                <textarea name="prompt" id="prompt" class="form-control" rows="5" required>{{ old('prompt') }}</textarea>
                            </div>
                        ...
                        <div class="mt-8">
                            <form action="{{ route('salesai.save') }}" method="POST">
                                ...
                                <div>
                                    ...
                                    <textarea name="edited_response" id="edited_response" class="form-control" rows="5" required>{{ $response }}</textarea>
                                    <input type="hidden" name="original_prompt" value="{{ $original_prompt }}">
                                </div>
                                <button type="submit" class="btn-success">Save Response</button>
                            </form>
                        </div>
                    @endif
                </div>
